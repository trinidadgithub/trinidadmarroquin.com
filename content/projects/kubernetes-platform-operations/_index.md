...
draft = false
description = 'Project discussions for Kubernetes platform operations, Rancher-managed clusters, upgrade planning, access standards, and platform conventions.'
tags = ['kubernetes', 'rancher', 'sre', 'platform']
categories = ['projects']
+++
