...
<div class="project-grid">
  <section class="project-card">
    ...
    <h2><a href="/tags/kubernetes/">Kubernetes And Rancher</a></h2>
  ...
  <section class="project-card">
    ...
    <h2><a href="/tags/vsphere/">vCenter Operations</a></h2>
  ...
  <section class="project-card">
    ...
    <h2><a href="/tags/terraform/">Terraform Change Review</a></h2>
  ...
  <section class="project-card">
    ...
    <h2><a href="/tags/packer/">Packer Builds</a></h2>
  ...
  <section class="project-card">
    ...
    <h2><a href="/tags/secrets/">Vault And Secrets</a></h2>
  ...
  <section class="project-card">
    ...
    <h2><a href="/tags/cloud/">Cloud Platforms</a></h2>
  ...
  <section class="project-card">
    ...
    <h2><a href="/tags/cicd/">CI/CD Pipelines</a></h2>
  ...
  <section class="project-card">
    ...
    <h2><a href="/tags/observability/">Observability And Incidents</a></h2>
