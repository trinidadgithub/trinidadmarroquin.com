...
- GitHub Actions CI: workflow trigger boundaries, runner trust, OIDC credentials, reusable workflow contracts, concurrency controls, and retained CI evidence.
- Monitoring Stack: Prometheus operations, Thanos and Mimir long-term metrics, Loki log queries, Tempo traces, retention, query safety, and incident correlation paths.
